"""
Django settings for tst_pr_events_dev_73995 project.
...
ROOT_URLCONF = 'tst_pr_events_dev_73995.urls'
...
WSGI_APPLICATION = 'tst_pr_events_dev_73995.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_pr_events_dev_73995 API",
    "DESCRIPTION": "API documentation for tst_pr_events_dev_73995 App",
    "VERSION": "v1",
}
